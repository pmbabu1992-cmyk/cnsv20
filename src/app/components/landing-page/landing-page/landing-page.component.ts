...
export class LandingPageComponent { 
 ...
 themeChange(type: string, type1: string) {
  ...
  primary(type: string) {
    ...
    localStorage.setItem('valex-primary-mode', type);
  ...
  cards = [
    {
      ...
      description: 'The Valex admin code is maintained very cleanly and well-structured with proper comments.',
    ...
    },
    {
      ...
      description: 'We included multiple demos, preview video, and screen shots to give a quick overview of our Valex admin template.',
    ...
    },
    {
      ...
      description: ' Different types of “Form Validation” are implemented in this Valex admin template and used strict validation rules. ',
      cardClass: 'main-features-4 active',
